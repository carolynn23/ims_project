...
<head>
    ...
    <meta name="description" content="Admin Dashboard for Internship Management System" />
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="#" class="menu-link">
                            ...
                            <div data-i18n="Approve Internships">Approve Internships</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="#" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-bar-chart"></i>
                            <div data-i18n="Reports">Generate Reports</div>
                        </a>
                    </li>
                </ul>
            </aside>
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            Manage users, approve internships, and generate reports from here.
                                        </p>
