            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">Welcome, <?php echo htmlspecialchars($user['name']); ?>!</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <strong>Student ID:</strong> <?php echo htmlspecialchars($user['student_id'] ?: 'Not set'); ?>
                                        </div>
                                        <div class="mb-3">
                                            <strong>Institution:</strong> <?php echo htmlspecialchars($user['institution'] ?: 'Not set'); ?>
                                        </div>
                                        <div class="mb-3">
                                            <strong>Department:</strong> <?php echo htmlspecialchars($user['department'] ?: 'Not set'); ?>
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <a href="internships.php" class="btn btn-primary">View Internship Opportunities</a>
                                    </div>
                                </div>
                            </div>
                        </div>
