...
<head>
    ...
    <title>IMS - Lecturer Dashboard</title>
    <meta name="description" content="Lecturer Dashboard for Internship Management System" />
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Lecturer /</span> Dashboard</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            Monitor student progress, review assessments, and assign grades from here.
                                        </p>
                                        <a href="#" class="btn btn-primary">Monitor Progress</a>
                                    </div>
                                </div>
                            </div>
                        </div>
