...
<head>
    ...
    <meta name="description" content="Student Dashboard for Internship Management System" />
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            This is your student dashboard. From here, you can apply for internships, view your applications, and submit reports.
                                        </p>
                                        <a href="apply_internship.php" class="btn btn-primary">Apply Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
